...
require(["dojo/dom",
    ...
    var map = new Map("mapDiv", {
        center: [105.29,15.527791],
        zoom: 5,
        basemap: "satellite"
    });

    //creates streamlines featuer layer and adds it to the map
    var featureLayer = new FeatureLayer("http://geoserver.byu.edu/arcgis/rest/services/sandbox/mekongstreams/MapServer/0");
    ...
    gp = new Geoprocessor("http://geoserver.byu.edu/arcgis/rest/services/sandbox/reservoirVolume/GPServer/Reservoir%20Volume");
